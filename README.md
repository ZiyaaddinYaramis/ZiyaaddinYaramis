...
**Full‑Stack Mobile & Web Developer (Flutter + React)**  
...
- 🔭 **Güncel odak**: Flutter + Firebase mimarileri, i18n, Auth, Firestore/RTDB, temiz mimari
- 📱 **Mobil**: Android (Flutter), plan: iOS uyumluluk
- 🌐 **Web**: React + Vite + Tailwind, JSON‑LD, SEO ve Lighthouse iyileştirmeleri
...
Hei! Olen Ziyaaddin, **full‑stack‑kehittäjä** (mobiili ja web). Rakennan **monikielisiä** (TR/EN/FI) sovelluksia Flutterilla ja Firebase:lla sekä moderneja sivustoja React/Vite/Tailwind‑pinolla. Tärkeitä teemoja: **saavutettavuus**, **suorituskyky**, **puhdas arkkitehtuuri** ja käytännöllinen toimitus.

- 🔭 **Fokus**: Flutter + Firebase (i18n, Auth, Firestore/RTDB), clean architecture
- 📱 **Mobiili**: Android (Flutter), iOS‑yhteensopivuus
- 🌐 **Web**: React + Vite + Tailwind, JSON‑LD, SEO, Lighthouse
- 🧪 **Laatu**: Axe/Lighthouse, NVDA/VoiceOver mini‑testit, kevyt CI
- 🧰 **Pino**: Dart/Flutter, Java, C#, Python, JS/TS, HTML/CSS, Firebase, Git/GitHub
- 🧭 **Brändi**: ZyInnova‑ekosysteemi
...
## 📊 Durum ve İstatistikler (optional)

- GitHub Stats Card  
  ![GitHub Stats](https://github-readme-stats.vercel.app/api?username=ZiyaaddinYaramis&show_icons=true)
